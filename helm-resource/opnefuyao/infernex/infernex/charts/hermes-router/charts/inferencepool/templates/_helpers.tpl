...
{{- $base := .Values.global.name | default .Release.Name | default "default-pool" | lower | trim | trunc 40 -}}
{{ $base }}-epp
{{- end -}}
...
{{- $base := .Values.global.name | default .Release.Name | default "default-pool" | lower | trim | trunc 40 }}
{{- $ns := .Values.global.namespace | default .Release.Namespace | default "default" | lower | trim | trunc 40 }}

...
#        --wait
    ...
    helm upgrade -i eg package/03-envoy-gateway/gateway-helm \
        -n envoy-gateway-system \
        --create-namespace \
        -f package/03-envoy-gateway/gateway-helm/values.yaml \
        -f package/04-envoy-ai-gateway/envoy-gateway-values.yaml \
        -f package/04-envoy-ai-gateway/envoy-gateway-values-addon.yaml \
        --wait
...
#        --create-namespace
    ...
    helm upgrade -i aieg-crd package/04-envoy-ai-gateway/ai-gateway-crds-helm \
        --namespace envoy-ai-gateway-system \
        --create-namespace
...
#        --create-namespace
    ...
    helm upgrade -i aieg package/04-envoy-ai-gateway/ai-gateway-helm \
        --namespace envoy-ai-gateway-system \
        --create-namespace \
        -f package/04-envoy-ai-gateway/ai-gateway-helm/values.yaml
